export const Skills = [
    ["HTML", "CSS", "Bootstrap", "JavaScript", "jQuery", "React", "Vue", "Git"],
    [
  ...
  export const Projects = [
    {
      id: 1,
      name: "Coin Tracker",
      desc: `CoinTracker is an application for tracking your monthly income as well as tracking your
      monthly expenses with the possibility of setting budget limits.`,
      image: "/assets/images/coinTrackerLogo.png",
      responsive: ["Mobile", "Dekstop", "Tablet"],
      technologies: ["React", "Material-UI"],
      github: "https://github.com/vladimirmomiroski/coinTracker",
      host: "https://coin-tracker15.netlify.app/",
    },
    {
      id: 2,
      name: "Goodies App",
    ...
    },
    {
      ...
      image: "/assets/images/streetArtistsLogo.png",
      responsive: ["Mobile"],
    ...
    },
    {
      id: 5,
      name: "Bike Shop",
      desc: `Mini bike-app, with a functionality to sort by gender and brand.`,
      image: "/assets/images/bikeLogo.png",
      responsive: ["Dekstop"],
      technologies: ["React"],
